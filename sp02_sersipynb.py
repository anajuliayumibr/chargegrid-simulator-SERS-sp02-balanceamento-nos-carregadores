...
Original file is located at
    https://colab.research.google.com/drive/1Ni93CNxjTnGr7ODgUgC81nfFb5P_v_Bi
"""
...
def menu_balanceamento():
    """
    Gerenciamento de múltiplos veículos com balanceamento automático.
    Limite fixo de 3 veículos conectados ao mesmo tempo.
    """
    print("\n" + "=" * 50)
    ...
    while True:
        ...
        # Só mostra a opção de conectar se houver menos de 3 veículos
        if len(carros) < 3:
        ...
        elif opcao == "1" and len(carros) >= 3:
            print("  ⚠️ Limite de 3 veículos atingido. Retorne ao menu principal.")
...
print("=" * 50)
print("  CHARGEGRID — SIMULADOR DE RECARGA")
print("=" * 50)

while True:
    print("\nSelecione uma opção:")
    print("  [1] Recarga individual (com recibo detalhado)")
    print("  [2] Balanceamento — até 3 veículos simultâneos")
